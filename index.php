...
<?php include('includes/nav.php'); ?>	
	<section id="work" class="page">
		<div class="logo">
				...
				<g>
					<path id="logoDot" d="M4.548,36.891c-0.614-0.654-0.92-1.436-0.92-2.351c0-0.914,0.306-1.696,0.92-2.35c0.613-0.652,1.375-0.979,2.287-0.979
						c0.849,0,1.587,0.327,2.216,0.979c0.629,0.654,0.943,1.436,0.943,2.35c0,0.882-0.314,1.658-0.943,2.327S7.684,37.87,6.835,37.87
						C5.923,37.87,5.161,37.545,4.548,36.891z"/>
